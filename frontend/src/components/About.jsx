    ...
    return (
        <div className="container my-5">
            <section className="about-section text-center mb-5">
                <h2 className="about-title display-5 mb-3">About Me</h2>
            ...
            <section className="about-section text-center mb-5">
                <h2 className="about-title display-5 mb-3">About DocuDefense</h2>
                <p className="about-text fs-5">
            ...
            <section className="about-section text-center mb-5">
                <h2 className="about-title display-5 mb-3">How DocuDefense Works</h2>
                <ul className="about-list list-unstyled fs-5">
                ...
                <p className="about-text fs-5 mt-3">
