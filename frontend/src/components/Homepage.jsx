        ...
        <div>
            <header className="container text-center my-5">
                <div className="card shadow-lg p-5">
                    <h1 className="display-4">Welcome to DocuDefense</h1>
                    <p className="lead">
            ...
            <section id="features" className="container my-5">
                <h2 className="text-center mb-4">Why Choose DocuDefense?</h2>
                <div className="row">
                    <div className="col-md-4">
                        <div className="card border-primary mb-4 shadow-sm">
                            <div className="card-body">
                                <h5 className="card-title">Secure Document Storage</h5>
                    ...
                    <div className="col-md-4">
                        <div className="card border-primary mb-4 shadow-sm">
                            <div className="card-body">
                                <h5 className="card-title">Seamless Collaboration</h5>
